...
pub struct Test {
    ...
    pub logger_sender: Sender<String>,
    pub logger_receiver: Receiver<String>,
}
...
fn test_simple_reservation_no_hotel() {
    ...
    reserve(
        test1.flight_reservations.get(0).unwrap().clone(),
        test1.airline.clone(),
...
fn test_one_request_with_holding_hotel() {
    ...
    reserve(
        test4.flight_reservations.get(0).unwrap().clone(),
        test4.airline.clone(),
...
fn test_volume() {
    ...
    // // Create vec with random true and false
    // let mut hotel = vec!();
    // for i in 0..100 {
    //     hotel.push(rand::random());
    // }
    // let test5 = Test::new(1000, hotel, 200);
    ...
    //             flight,
    //             test5.airline.clone(),
    //             test5.statistics.clone(),
    //             test5.logger_sender.clone(),
    //         );});
    //     );
    // }
    ...
    //     thread.join().unwrap();
    // }
    // assert_eq!(statistics.get_total_count(), 2);
    // assert_eq!(statistics.get_ /avg_time(), XXX);
}